...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Deletion of the HEIC file from the source S3 bucket
...
// (async () => {
//   const inputBuffer = await promisify(fs.readFile)("./IMG_4643.HEIC");
//   const outputBuffer = await convert({
//     buffer: inputBuffer, // the HEIC file buffer
//     format: "PNG", // output format
//   });

//   await promisify(fs.writeFile)("./ZermattLake.png", outputBuffer);
// })();
